...
class StylesControllerTest < ActionController::TestCase
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post :create, style: { culture: @style.culture, exterior: @style.exterior, interior: @style.interior }
    end
  ...
  test "should update style" do
    put :update, id: @style, style: { culture: @style.culture, exterior: @style.exterior, interior: @style.interior }
    assert_redirected_to style_path(assigns(:style))
  end
